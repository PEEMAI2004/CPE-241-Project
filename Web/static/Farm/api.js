...
if (document.getElementById("beeHiveForm")) {
...
if (document.getElementById("queenBeeForm")) {
  loadDropdown("beehive", "beehiveDropdown", "beehive_id", "beehive_status");
}

// Add event listeners for the harvestlog form and load dropdowns
if (document.getElementById("harvestLogForm")) {
  loadDropdown("beehive", "beehiveDropdown", "beehive_id", "beehive_status");
}
